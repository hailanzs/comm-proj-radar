...
config_lua_script = r'' # relative path to the lua scripts for continuous it in is the home dir(ex. scripts/1843_config_streaming.lua)
record_lua_script = r'' # relative path to the lua scripts for recording it in is the home dir(ex. scripts/1843_record.lua)
